...
static struct dentry *msdos_lookup(struct inode *dir, struct dentry *dentry,
				   unsigned int flags)
{
	printk(KERN_INFO "use of msdos_lookup(FOLDER (namei_msdos.c))\n");
...
static int msdos_create(struct inode *dir, struct dentry *dentry, umode_t mode,
			bool excl)
{
	printk(KERN_INFO "use of msdos_create(FOLDER (namei_msdos.c))\n");
	struct super_block *sb = dir->i_sb;
...
{
	printk(KERN_INFO "use of msdos_rmdir(FOLDER (namei_msdos.c))\n");
	struct super_block *sb = dir->i_sb;
...
{
	printk(KERN_INFO "use of msdos_mkdir(FOLDER (namei_msdos.c))\n");
	struct super_block *sb = dir->i_sb;
	struct fat_slot_info sinfo;
	struct inode *inode;
	unsigned char msdos_name[MSDOS_NAME];
...
{
	printk(KERN_INFO "use of msdos_unlink(FOLDER (namei_msdos.c))\n");
	struct inode *inode = d_inode(dentry);
...
static int msdos_rename(struct inode *old_dir, struct dentry *old_dentry,
			...
			unsigned int flags)
{
	printk(KERN_INFO "use of msdos_rename(FOLDER (namei_msdos.c))\n");
